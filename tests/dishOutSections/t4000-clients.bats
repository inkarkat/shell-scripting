...
@test "three clients seeking and seeking after" {
    run -0 dishOutSections "${BATS_TEST_DIRNAME}/numbers.txt"
    assert_output 'one'
    ...
    run -0 dishOutSections --for B --seek-after 1 "${BATS_TEST_DIRNAME}/numbers.txt"
    assert_output 'ten'

    run -0 dishOutSections --for A --seek-after 3 "${BATS_TEST_DIRNAME}/numbers.txt"
    assert_output 'twelve'
    ...
    run -0 dishOutSections --seek-after 2 "${BATS_TEST_DIRNAME}/numbers.txt"
    assert_output 'two'
